...
* *Downloading a zip file*
   ...
   From the main [Django-Recommendation-system](https://github.com/soma2000-lang/Django-Recommendation-system), 
...
Use PostGreSQL’s admin tool pgadmin to create a database. N
